...
namespace Viking
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //Генерация дат рождения (200 штук)
            db.GenerationBirthDates();
            //Генерация дат покупки абонемента (200 штук)
            ...
            CalculationAge();
            //Отображение статуса абонемента (истек\актив)
            CalculationStatusAbonement();
            //Добавление вариантов выбора статуса и абонемента
            AddComboBoxItems();
        ...
        //Передача данных строки при нажатии
